...
%Basic unit of modelling is an \texttt{object}.
%
%What is it?
%A snapshot of an entity's state in a timeline.
%
%What do they represent in a real system?
%Objects are modified by \texttt{processes}.
%
%To distinguish between the global view of the system and the local view as seen by a program we introduce the concept of global and local objects.
%
%PVM essentially formalises the relationship between local and global objects.
%Introduce the concept of binding and unbinding.

% Example with a simple file open and close.
% Example with a concurrent access case, open, unlink, close.
