...
% Analyser in logging mode, Full capture

% Analyser in logging mode, Lite capture

% Analyser in PVM mode, Full capture

% Analyser in PVM mode, Lite Capture
...
% Capture must not be circumventable.

% Capture must be tamper proof.

% Capture should have visibility across layers of abstraction.
...
% Some of the security guarantees that the access control mechanism guarantees.
...
%TODO: Think how some of the security properties claimed above can be proved
...
% Verify integrity of data on storage.
% OS must provide proof of integrity and provenance for individual blocks.
% The Arbiter can verify this proof.
